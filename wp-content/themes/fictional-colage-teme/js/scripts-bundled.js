...
/*#__PURE__*/
function () {
  //1. describa and create/initiate our object
  function Search() {
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(colageData.root_url + '/wp-json/colage/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join(''), "\n                        ").concat(results.generalInfo.length ? '</ul>' : '', "\n                    </div>\n                    <div class=\"one-third\">\n                        <h2 class=\"search-overlay__section-title\">Programs</h2>\n                         ").concat(results.programs.length ? '<ul class="link-list min-list">' : "<p>No programs matches that search. <a href=\"".concat(colageData.root_url, "/programs\">View all programs</a></p>"), "\n                          ").concat(results.programs.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n                         ").concat(results.programs.length ? '</ul>' : '', "\n                                                \n                        <h2 class=\"search-overlay__section-title\">Professors</h2>\n                         ").concat(results.professors.length ? '<ul class="prtofessor-cards">' : "<p>No professors matches that search.</p>", "\n                          ").concat(results.professors.map(function (item) {
        ...
        }).join(''), "\n                         ").concat(results.professors.length ? '</ul>' : '', "\n                        \n                    </div>\n                    <div class=\"one-third\">\n                        <h2 class=\"search-overlay__section-title\">Campuses</h2>\n                         ").concat(results.campuses.length ? '<ul class="link-list min-list">' : "<p>No campuses matches that search. <a href=\"".concat(colageData.root_url, "/campuses\">View all campuses</a></p>"), "\n                          ").concat(results.campuses.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n                         ").concat(results.campuses.length ? '</ul>' : '', "     \n          \n                                \n                        <h2 class=\"search-overlay__section-title\">Events</h2>\n                         ").concat(results.events.length ? '' : "<p>No events matches that search. <a href=\"".concat(colageData.root_url, "/events\">View all events</a></p>"), "\n                          ").concat(results.events.map(function (item) {
